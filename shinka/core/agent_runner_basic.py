...
class AgentMultiTurnEvolutionRunner(EvolutionRunner):
    ...
    def _submit_new_job(self):
        ...
        if self.evo_config.agent_include_parent_context or not self.agent_msg_history:
            ...
            agent_patch_msg = (
                "Use the prior attempt's feedback to propose a better full program.\n\n"
            ...
            agent_patch_msg = FULL_ITER_MSG_NO_CONTEXT.format(
                language=self.evo_config.language,
