...
uv pip install -e .
shinka_launch variant=circle_packing_example \
    "evo_config.llm_models=[gemini-2.5-flash]" \
    evo_config.embedding_model=gemini-embedding-001
...
shinka_launch variant=circle_packing_example \
    ...
    cluster=local \
    "evo_config.llm_models=[gemini-2.5-flash]" \
    "+evo_config.llm_kwargs.temperatures=[0.0,0.5]" \
    "+evo_config.llm_kwargs.max_tokens=16384" \
    "evo_config.patch_types=[diff,full,cross]" \
    "evo_config.patch_type_probs=[0.6,0.3,0.1]" \
    "evo_config.num_generations=20" \
    "evo_config.max_parallel_jobs=1" \
    "+evo_config.max_patch_resamples=3" \
    "evo_config.max_patch_attempts=3" \
    "evo_config.embedding_model=gemini-embedding-001" \
    "evo_config.init_program_path=examples/circle_packing/initial.py" \
    "job_config.eval_program_path=examples/circle_packing/evaluate.py"
...
shinka_launch variant=circle_packing_example \
    ...
    "evo_config.max_patch_attempts=3" \
    "evo_config.embedding_model=gemini-embedding-001" \
    "evo_config.results_dir=results/circle_packing/run" \
    "evo_config.init_program_path=examples/circle_packing/initial.py" \
    "job_config.eval_program_path=examples/circle_packing/evaluate.py"
...
shinka_launch variant=circle_packing_example \
    ...
    evolution=small_budget \
    cluster=local \
    "evo_config.llm_models=[gemini-2.5-pro]" \
    "+evo_config.llm_kwargs.temperatures=[0.0,0.5]" \
    "+evo_config.llm_kwargs.max_tokens=16384" \
    "evo_config.patch_types=[diff,full,cross]" \
    "evo_config.patch_type_probs=[0.6,0.3,0.1]" \
    ...
    "evo_config.max_patch_attempts=3" \
    "evo_config.embedding_model=gemini-embedding-001" \
    "evo_config.results_dir=results/circle_packing/run_pro" \
    "evo_config.init_program_path=examples/circle_packing/initial.py" \
    "job_config.eval_program_path=examples/circle_packing/evaluate.py"
...
shinka_launch variant=circle_packing_example \
    "evo_config.llm_models=[gemini-2.5-flash]" \
    "evo_config.meta_llm_models=[gemini-2.5-flash]" \
    evo_config.embedding_model=gemini-embedding-001
